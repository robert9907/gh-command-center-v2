...
'Use the exact HTML structure and CSS classes from the GH Master Template v5.7.1.\n' +
...
'• Start directly with the hero section HTML — no preamble\n' +
'• Use the exact CSS classes from the template — they are already deployed\n' +
'• Fill in all bracket placeholders with real content for THIS keyword\n' +
'• Include <!-- NEPQ QUOTE BREAK --> placeholders where they belong\n' +
